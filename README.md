...
Graph assets are bundled locally. Running or building Syncly does not require Node or a network
connection for graph rendering. The pinned d3-force bundle and official Lucide icon subset,
